...
if($_SESSION['form'] && $_SESSION['user']){
    ...
    $image_path = isset($_FILES['image']) ? "images/" . uniqid() . "_" . $_FILES['image']['name'] : null; // 画像パス（アップロードされた場合のみ）
}
...
<body>
    ...
    <form method="post" action="createThreadCheck.php">
        <div class="thread-preview">
            <h2><?php echo $_SESSION['form']['title']; ?></h2>
            <hr />
            <p><?php echo nl2br($_SESSION['form']['content']); ?></p>
        </div>
